...
creditLbl=Create("TextLabel",main,{Position=UDim2.new(0,0,1,5),Size=UDim2.new(0,100,0,15),BackgroundTransparency=1,TextColor3=Color3.new(1,1,1),Text="Fixed By Friskshift",TextScaled=true,TextStrokeTransparency=.8})
...
for i, counter in pairs(workspace.SupplyCounters:GetChildren()) do
	counter.Name = "Counter" .. i
end

for name in pairs(supplyCounts) do
	for _, counter in pairs(workspace.SupplyCounters:GetChildren()) do
		local lbl = counter[name == "Dew" and "CounterMountainDew" or "Counter"..name].a.SG.Counter
